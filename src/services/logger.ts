...
// Function to create DailyRotateFile transports for each level
// const createDailyRotateFileTransports = (levels: { [key: string]: number }) => {
//   return Object.keys(levels).map(level => new DailyRotateFile({
...
//   defaultMeta: { system: "main" },
  transports: [
    ...
    // ...createDailyRotateFileTransports(myCustomLevels.levels)
  ],
